...
class CartItem implements Arrayable, Jsonable
{
     ...
     * @param array      $options
     */
    public function __construct($id, $name, $price, $taille, array $options = [])
    {
        if(empty($id)) {
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public static function fromAttributes($id, $name, $price, $taille, array $options = [])
    {
        return new self($id, $name, $price, $taille, $options);
    }
