          ...
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i>Ajout de la publicites</h3>
              </div>
                ...
                <form role="form" method="post" action="{{ action('Admin@stors') }}" enctype="multipart/form-data">
                     @csrf
                        <div class="form-group col-md-6">
                            <label>Publicite 1</label>
                            <input type="file" class="form-control" name="image1"><br>
                            <label>Publicite 1</label>
                            <input type="text" class="form-control" placeholder="lien de la Publicite" name="Lien1">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label>Publicite 2</label>
                            <input type="file" class="form-control" name="image2"><br>
                            <label>Publicite 2</label>
                            <input type="text" class="form-control" placeholder="lien de la Publicite" name="lien2">
                        </div>
                        <div class="form-group col-md-6">
                            <div class="" style="border: 1px solid #000; height: 120px; width: 100%; margin: 20px 0px;">
                        ...
                        <div class="form-group col-md-6">
                            <label>Publicite 3</label>
                            <input type="file" class="form-control" name="image3"><br>
                            <label>Publicite 3</label>
                            <input type="text" class="form-control" placeholder="lien de la Publicite" name="lien3">
                        </div>
                        <div class="form-group col-md-6">
                            <div class="" style="border: 1px solid #000; height: 120px; width: 100%; margin: 20px 0px;">
